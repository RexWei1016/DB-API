...
-- 教練基本資訊表
CREATE TABLE Coach (
    cID VARCHAR(50) PRIMARY KEY,     -- 教練帳號 (主鍵，由教練自行設定)
    pwd VARCHAR(50) NOT NULL,        -- 教練密碼
    name VARCHAR(100) NOT NULL,      -- 教練姓名
...
CREATE TABLE Consultation (
    cID VARCHAR(50) REFERENCES Coach(cID), -- 教練帳號，外鍵參照 Coach 表
    ID VARCHAR(50) REFERENCES AppUser(ID), -- 使用者帳號，外鍵參照 AppUser 表
